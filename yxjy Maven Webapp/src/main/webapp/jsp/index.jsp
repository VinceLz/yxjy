		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						<div class="dropdown profile-element">
							<span><img alt="image" class="img-circle"
								src="<%=application.getContextPath()%>/img/profile_small.jpg" />
					...
					<li><a href="mailbox.html"><i class="fa fa-envelope"></i>
							<span class="nav-label">产品</span> </a>
						<ul class="nav nav-second-level">
					...
					<li><a href="mailbox.html"><i class="fa fa-envelope"></i>
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="<%=application.getContextPath()%>/medid/video.action">文章列表</a>
							</li>
					...
					<li><a href="mailbox.html"><i class="fa fa-envelope"></i>
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="table_data_tables.html">文章列表</a>
							</li>
					...
					<li><a href="mailbox.html"><i class="fa fa-envelope"></i>
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="<%=application.getContextPath()%>/product/get.action">产品</a>
							</li>
					...
					<li><a href="mailbox.html"><i class="fa fa-envelope"></i>
							<span class="nav-label">系统设置</span> </a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="table_data_tables.html">文章列表</a>
							</li>
					...
					<li><a href="#"><i class="fa fa-table"></i> <span
						...
						<ul class="nav nav-second-level">
							...
							<li><a class="J_menuItem" href="table_bootstrap.html">Bootstrap
									Table <span class="label label-danger pull-right">推荐</span> </a>
							</li>
						</ul>
					</li>
